...
const GenerateFitReportOutputSchema = z.object({
    ...
    experience: z.object({
        ...
        candidateYears: z.number().describe('The number of years of experience detected in the resume.'),
        requiredYears: z.number().optional().describe('The number of years of experience required by the job description.'),
